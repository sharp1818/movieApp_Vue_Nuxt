...
export default {
  ...
  async fetch() {
    ...
    await this.searchMovies()
      ...
      head(){
        return{ title:'Movie-App - Info' }
      },
  fetchDelay:1000,
  methods: {
    async getMovies() {
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=4365965062b4ea5e14bb545b612cd44e&language=en-US&page=1')
    ...
    async searchMovies() {
      const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=4365965062b4ea5e14bb545b612cd44e&language=en-US&page=1&query=${this.searchInput}`)
      const result = await data
      result.data.results.forEach( movie => {
